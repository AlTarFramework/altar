...
class Reverso(altar.models.bayesian, family="altar.models.reverso"):
    """
    An implementation of the Reverso 2-Magma-Chamber Volcano Model, Reverso etal. [2014].
    """
    ...
    def initializeParameterSets(self):
        ...
        # radius of the hydraulic pipe connecting the two reservoirs
        self.acIdx = psets['radius of connecting hydraulic pipe (m)'].offset
        # radius of the shallow reservoir
        self.asIdx = psets['radius of shallow reservoir (m)'].offset
        # radius of the deep reservoir
        self.adIdx = psets['radius of deep reservoir (m)'].offset
        # depth of the shallow reservoir
        self.hsIdx = psets['depth of shallow reservoir (m)'].offset

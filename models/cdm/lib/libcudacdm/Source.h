...
// code guard
#if !defined(altar_models_cudacdm_Source_h)
#define altar_models_cudacdm_Source_h
...
// the cudacdm source
class altar::models::cudacdm::Source {
    // types
public:
...
#define altar_models_cudacdm_Source_icc
#include "Source.icc"
#undef altar_models_cudacdm_Source_icc

...
// the implementation
#include <altar/models/mogi/Source.h>
// my header
#include "source.h"
// the capsules
#include "capsules.h"
...
// type aliases
using source_t = altar::models::mogi::source_t;
...
newSource(PyObject *, PyObject * args)
{
    ...
    int status = PyArg_ParseTuple(args, "d:newSource", &nu);
    ...
    // make a new source
    source_t * source = new source_t(nu);
...
void freeSource(PyObject * capsule) {
    const char * const source_capst = altar::extensions::models::mogi::source_capst;

...
// the implementation
#include <altar/models/cudamogi/Source.h>
// my header
#include "source.h"
// the capsules
#include "capsules.h"
...
// type aliases
using source_t = altar::models::cudamogi::source_t;
...
void freeSource(PyObject * capsule) {
    const char * const source_capst = altar::extensions::models::cudamogi::source_capst;

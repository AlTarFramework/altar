...
// uniform_sample
const char * const altar::extensions::utils::matrix_condition__name__ = "matrix_condition";
const char * const altar::extensions::utils::matrix_condition__doc__ =
    "check/adjust a matrix to be well-conditioned";

PyObject *
altar::extensions::utils::matrix_condition(PyObject *, PyObject * args) {
    // the arguments
    PyObject * matrixCapsule;

    // build my debugging channel
    pyre::journal::debug_t debug("altar.utils::matrix_condition");

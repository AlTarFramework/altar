...
# declaration
class GridDbetaSolver(altar.component, family="altar.dbetasolver.griddbetasolver", implements=dbetasolver):
    """
    The δβ Solver based on Grid searching
    """
    ...
    def solve(self, minimizer, llk, weight):
        ...
        return altar.libaltar.dbeta_grid(minimizer, llk.data, median, weight.data)
